...
my $synctimeout = 600;
my $getopt;
my ($channellist, $channel, @includechannels);
my @excludechannels;
#my @excludechannels=( "centos-6-64-updates", "centos-6-64-extras", "centos-6-64-centosplus", "pgdg92_rhel6", "puppet-dependencies-centos6", "puppetlabs-rhel6", "spacewalk-client-1.8", "spacewalk-svr-repo", "Spacewalk_Client_CentOS_6-x86_64", "centos-5-64-updates", "centos-5-64-extras", "centos-5-64-centosplus", "pgdg92_rhel5", "puppet-dependencies-centos5", "puppetlabs-rhel5", "spacewalk-svr-repo", "Spacewalk_Client_CentOS_5-x86_64","epel6-x86_64","epel5-x86_64", "Spacewalk_Client_CentOS_6-x86_64", "Spacewalk_Client_CentOS_5-x86_64");
